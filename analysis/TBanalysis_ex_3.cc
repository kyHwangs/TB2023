...
int main(int argc, char** argv) {
    ...
    for (int iEvt = 0; iEvt < totalEntry; iEvt++) {
        ...
        float C_counter_1_ped = util->retrievePed(C_counter_1_cid);
        float C_counter_2_ped = util->retrievePed(C_counter_2_cid);
    ...
    // Save the outputs
    std::string outFile = "./Sample_analysis_Run_" + std::to_string(runNum) + "_ex_3.root";
